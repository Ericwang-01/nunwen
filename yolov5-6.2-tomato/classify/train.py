...
def parse_opt(known=False):
    ...
    parser.add_argument('--model', type=str, default=r'D:\YOLO\yolov5-6.2-tomato\classify\yolov5s-cls.pt', help='initial weights path')
    parser.add_argument('--data', type=str, default=r'C:\Users\24686\Desktop\appletest', help='cifar10, cifar100, mnist, imagenet, etc.')
