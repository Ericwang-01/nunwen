...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    #best_fitness, start_epoch = 300, 0
    if pretrained:
        if resume:
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Backward
            torch.use_deterministic_algorithms(False)  #加的cbam
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'D:\YOLO\yolov5-6.2-tomato\yolov5s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=r'D:\YOLO\yolov5-6.2-tomato\models\yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'D:\YOLO\yolov5-6.2-tomato\data\tomato.yaml', help='dataset.yaml path')
